...
pub struct R(crate::R<DMA0SZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA0SZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA0SZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA0SZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA0SZ` writer"]
pub struct W(crate::W<DMA0SZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA0SZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA0SZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA0SZ_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
