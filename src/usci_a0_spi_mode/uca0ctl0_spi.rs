...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
...
pub type UCMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCA0CTL0_SPI_SPEC, u8, UCMODE_A, 2, O>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
...
pub type UCCKPL_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
...
pub type UCCKPH_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA0CTL0_SPI_SPEC, bool, O>;
impl R {
