...
pub struct RegisterBlock {
    ...
    _reserved1: [u8; 0x18],
    #[doc = "0x1a - TLV ADC12_1 TAG"]
    pub tlv_adc12_1_tag: TLV_ADC12_1_TAG,
    #[doc = "0x1b - TLV ADC12_1 LEN"]
    pub tlv_adc12_1_len: TLV_ADC12_1_LEN,
    _reserved3: [u8; 0x1a],
...
#[doc = "TLV_ADC12_1_TAG (rw) register accessor: an alias for `Reg<TLV_ADC12_1_TAG_SPEC>`"]
pub type TLV_ADC12_1_TAG = crate::Reg<tlv_adc12_1_tag::TLV_ADC12_1_TAG_SPEC>;
#[doc = "TLV ADC12_1 TAG"]
pub mod tlv_adc12_1_tag;
#[doc = "TLV_ADC12_1_LEN (rw) register accessor: an alias for `Reg<TLV_ADC12_1_LEN_SPEC>`"]
pub type TLV_ADC12_1_LEN = crate::Reg<tlv_adc12_1_len::TLV_ADC12_1_LEN_SPEC>;
#[doc = "TLV ADC12_1 LEN"]
pub mod tlv_adc12_1_len;
