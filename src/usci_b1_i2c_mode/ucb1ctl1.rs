...
pub type UCTR_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1CTL1_SPEC, bool, O>;
...
pub type UCSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCB1CTL1_SPEC, u8, UCSSEL_A, 2, O>;
