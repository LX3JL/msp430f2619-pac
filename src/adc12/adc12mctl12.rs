...
pub type INCH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, ADC12MCTL12_SPEC, u8, INCH_A, 4, O>;
...
pub type SREF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, ADC12MCTL12_SPEC, u8, SREF_A, 3, O>;
...
pub type EOS_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADC12MCTL12_SPEC, bool, O>;
impl R {
