...
pub type UCOS16_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1MCTL_SPEC, bool, O>;
...
pub type UCBRS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCA1MCTL_SPEC, u8, UCBRS_A, 3, O>;
...
pub type UCBRF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCA1MCTL_SPEC, u8, UCBRF_A, 4, O>;
