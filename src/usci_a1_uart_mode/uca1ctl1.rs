...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCTXBRK_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCTXADDR_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCDORM_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCBRKIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCRXEIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL1_SPEC, bool, O>;
...
pub type UCSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCA1CTL1_SPEC, u8, UCSSEL_A, 2, O>;
