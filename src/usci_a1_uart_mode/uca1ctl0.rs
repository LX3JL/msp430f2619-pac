...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
...
pub type UCMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCA1CTL0_SPEC, u8, UCMODE_A, 2, O>;
...
pub type UCSPB_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
...
pub type UCPAR_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
...
pub type UCPEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1CTL0_SPEC, bool, O>;
impl R {
