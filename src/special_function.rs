...
pub mod ifg2;
#[doc = "UC1IE (rw) register accessor: an alias for `Reg<UC1IE_SPEC>`"]
pub type UC1IE = crate::Reg<uc1ie::UC1IE_SPEC>;
#[doc = "USCI 1 Interrupt Enable"]
pub mod uc1ie;
#[doc = "UC1IFG (rw) register accessor: an alias for `Reg<UC1IFG_SPEC>`"]
pub type UC1IFG = crate::Reg<uc1ifg::UC1IFG_SPEC>;
